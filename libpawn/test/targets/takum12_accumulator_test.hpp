...
TEST_CASE("Takum12Target qaClear and qaRead", "[accumulator][takum12]") {
...
TEST_CASE("Takum12Target qaAdd", "[accumulator][takum12]") {
    p::Takum12Target target;
...
TEST_CASE("Takum12Target qaFma", "[accumulator][takum12]") {
    p::Takum12Target target;
...
TEST_CASE("Takum12Target qaFms", "[accumulator][takum12]") {
    p::Takum12Target target;
    p::Number a = target.toNumber(2.0f);
    p::Number b = target.toNumber(3.0f);
    target.qaClear();
...
TEST_CASE("Takum12Target qaNeg", "[accumulator][takum12]") {
    p::Takum12Target target;
    p::Number a = target.toNumber(5.0f);
    target.qaClear();
    target.qaAdd(a);
