...
TEST_CASE("Tfloat32Target qaClear and qaRead", "[accumulator][tfloat32]") {
...
TEST_CASE("Tfloat32Target qaAdd", "[accumulator][tfloat32]") {
    p::Tfloat32Target target;
...
TEST_CASE("Tfloat32Target qaFma", "[accumulator][tfloat32]") {
    p::Tfloat32Target target;
...
TEST_CASE("Tfloat32Target qaFms", "[accumulator][tfloat32]") {
    p::Tfloat32Target target;
    p::Number a = target.toNumber(2.0f);
    p::Number b = target.toNumber(3.0f);
    target.qaClear();
...
TEST_CASE("Tfloat32Target qaNeg", "[accumulator][tfloat32]") {
    p::Tfloat32Target target;
    p::Number a = target.toNumber(5.0f);
    target.qaClear();
    target.qaAdd(a);
