...
TEST_CASE("Posit32Target creation", "[target][posit32]") {
    p::Posit32Target target;
    REQUIRE(target.dataWidth == 32);
}

TEST_CASE("Posit32Target toNumber from float", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toNumber from double", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toNumber from int32_t", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toNumber from uint32_t", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toNumber from int64_t", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toNumber from uint64_t", "[conversion][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target add", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target sub", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target mul", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target div", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target neg", "[arithmetic][posit32]") {
    p::Posit32Target target;
    p::Number a = target.toNumber(5.0f);
...
TEST_CASE("Posit32Target abs", "[arithmetic][posit32]") {
    p::Posit32Target target;
    p::Number a = target.toNumber(-5.0f);
...
TEST_CASE("Posit32Target sqrt", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target relu", "[arithmetic][posit32]") {
    p::Posit32Target target;
...
TEST_CASE("Posit32Target toString", "[conversion][posit32]") {
    p::Posit32Target target;
    p::Number n = target.toNumber(3.14f);
