...
# ----------------------------------------------------------------------------
#
# NOTE: All pin assignments below are commented out because this design uses
# the Zynq PS7 processing system. All communication with PL goes through the
# internal AXI interconnect (M_AXI_GP0), not through external PL I/O pins.
# DDR and FIXED_IO pins are handled by the PS7 IP block.
#
# Uncomment specific pins if you add PL-side I/O (e.g., LEDs for debug).
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
#create_clock -period 10 [get_ports {GCLK}];  # virtual clock frequency for timing analysis!
