...
std::pair<float, float> dispatch_cifar(
    ...
    if (nbits == 10 && es == 1) return run_inference_cifar<10, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 10 && es == 2) return run_inference_cifar<10, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 10 && es == 3) return run_inference_cifar<10, 3, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 1) return run_inference_cifar<12, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 2) return run_inference_cifar<12, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 3) return run_inference_cifar<12, 3, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 1) return run_inference_cifar<14, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 2) return run_inference_cifar<14, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 3) return run_inference_cifar<14, 3, FromType, ModelT>(ckpt, data);
...
std::pair<float, float> dispatch_mnist(
    ...
    if (nbits == 10 && es == 1) return run_inference_mnist<10, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 10 && es == 2) return run_inference_mnist<10, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 10 && es == 3) return run_inference_mnist<10, 3, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 1) return run_inference_mnist<12, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 2) return run_inference_mnist<12, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 12 && es == 3) return run_inference_mnist<12, 3, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 1) return run_inference_mnist<14, 1, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 2) return run_inference_mnist<14, 2, FromType, ModelT>(ckpt, data);
    if (nbits == 14 && es == 3) return run_inference_mnist<14, 3, FromType, ModelT>(ckpt, data);
...
std::pair<float, float> dispatch_native_cifar(
    ...
    if (nbits == 10 && es == 1) return run_inference_native_cifar<10, 1, ModelT>(ckpt, data);
    if (nbits == 10 && es == 2) return run_inference_native_cifar<10, 2, ModelT>(ckpt, data);
    if (nbits == 10 && es == 3) return run_inference_native_cifar<10, 3, ModelT>(ckpt, data);
    if (nbits == 12 && es == 1) return run_inference_native_cifar<12, 1, ModelT>(ckpt, data);
    if (nbits == 12 && es == 2) return run_inference_native_cifar<12, 2, ModelT>(ckpt, data);
    if (nbits == 12 && es == 3) return run_inference_native_cifar<12, 3, ModelT>(ckpt, data);
    if (nbits == 14 && es == 1) return run_inference_native_cifar<14, 1, ModelT>(ckpt, data);
    if (nbits == 14 && es == 2) return run_inference_native_cifar<14, 2, ModelT>(ckpt, data);
    if (nbits == 14 && es == 3) return run_inference_native_cifar<14, 3, ModelT>(ckpt, data);
...
std::pair<float, float> dispatch_native_mnist(
    ...
    if (nbits == 10 && es == 1) return run_inference_native_mnist<10, 1, ModelT>(ckpt, data);
    if (nbits == 10 && es == 2) return run_inference_native_mnist<10, 2, ModelT>(ckpt, data);
    if (nbits == 10 && es == 3) return run_inference_native_mnist<10, 3, ModelT>(ckpt, data);
    if (nbits == 12 && es == 1) return run_inference_native_mnist<12, 1, ModelT>(ckpt, data);
    if (nbits == 12 && es == 2) return run_inference_native_mnist<12, 2, ModelT>(ckpt, data);
    if (nbits == 12 && es == 3) return run_inference_native_mnist<12, 3, ModelT>(ckpt, data);
    if (nbits == 14 && es == 1) return run_inference_native_mnist<14, 1, ModelT>(ckpt, data);
    if (nbits == 14 && es == 2) return run_inference_native_mnist<14, 2, ModelT>(ckpt, data);
    if (nbits == 14 && es == 3) return run_inference_native_mnist<14, 3, ModelT>(ckpt, data);
