...
echo "  sim_pau8             — PAU  8-bit (FloPoCo, es=2, exact quire)"
echo "  sim_pau16            — PAU 16-bit (FloPoCo, es=2, exact quire)"
echo "  sim_pau32            — PAU 32-bit exact quire"
echo "  sim_pau32_approx     — PAU 32-bit approx-mul"
echo "  sim_pau64            — PAU 64-bit exact quire"
echo "  sim_fpu32            — FPU 32-bit (IEEE 754 single)"
echo "  sim_fpu64            — FPU 64-bit (IEEE 754 double)"
echo "  sim_pau8_noquire     — PAU  8-bit no quire (register accumulator)"
echo "  sim_pau16_noquire    — PAU 16-bit no quire (register accumulator)"
echo "  sim_pau32_noquire    — PAU 32-bit no quire (register accumulator)"
